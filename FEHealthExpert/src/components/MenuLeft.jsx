  ...
  return (
    <>
      <aside
        ...
        aria-label="Sidebar"
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-orange-400">
          <ul class="space-y-6 font-medium bg-orange-400">
            <li>
              <a
                href="/ManageCourse"
              ...
              >
                ...
                <span class="ms-3 font-bold">Khóa học</span>
              </a>
            </li>
            <a
              href="/ManageSession"
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap font-bold">
                Buổi học
              </span>
            </a>
            <a
