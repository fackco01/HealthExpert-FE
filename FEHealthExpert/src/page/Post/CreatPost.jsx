...
export default function CreatePost() {
  ...
  function getProfile(username) {
    axios.get(`http://20.2.73.15:8173/api/Account/GetListAccount`, {
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post('http://20.2.73.15:8173/api/post', { title: post.title, content: post.content, imageFile: post.imageFile, accountId: accountId });
